        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                ...
                <div class="navbar nav_title" style="border: 0;">
                    <a href="/" class="site_title"><i class="fa fa-paw"></i> <span>Dance Globe</span></a>
                </div>
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    ...
                    <div class="menu_section">
                        <h3>General</h3>
<?php
 $menuItems[] =  ["label" => "Home", "url" => "index.php?r=site/index", "icon" => "home"];
...
?>
        ...
        <footer>
             <div class="pull-right">
                Copywrite <a href="#" rel="nofollow" target="_blank">Dance Globe</a><br />
                 </div>
